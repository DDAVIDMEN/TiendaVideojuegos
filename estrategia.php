<?php
    ...
    $query = "select pro.id,pro.fotos,pro.nombre 
     from productos pro, categoria cat where cat.id = pro.categoria and cat.id = 3;";
...
<body>
    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
                    ...
                    <div class="collapse navbar-collapse" id="collapsibleNavbar">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item active" href="estrategia.php">Estrategia</a></li>
        ...
        <br>
        <h2 class= "my-2"> Juegos de Estrategia</h2>
        <br>
        <div class="container">
        <div class="row">
                <?php
