<?php
    ...
    JOIN categoria cat ON cat.ID = p.Categoria GROUP BY p.ID HAVING COUNT(pp.Plataforma) = 1 AND MAX(pp.Plataforma) = 1;";
...
<body>
    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
        <div class="container text-center">
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle active" href="#" role="button" data-bs-toggle="dropdown">Exclusivos</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item active" href="play.php">PlayStation</a></li>
        ...
        <br>
        <h2 class= "my-2">Exclusivos de PlayStation</h2>
        <br>
        <div class="container">
        <div class="row">
            <?php
